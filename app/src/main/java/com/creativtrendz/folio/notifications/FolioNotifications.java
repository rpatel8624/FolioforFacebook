...
public class FolioNotifications extends Service {
    ...
    private void notifier(String title, String url, boolean isMessage) {
        ...
        if (isMessage)
            contentTitle = getString(R.string.app_name_toolbar) + " " + getString(R.string.messages);
        else
            contentTitle = getString(R.string.app_name_toolbar) + " " + getString(R.string.notifications);
        ...
        NotificationCompat.Action action = new NotificationCompat.Action.Builder(R.drawable.ic_mess_tabs, getString(R.string.app_name), actionPendingIntent)
                        .build();

        NotificationCompat.Action message = new NotificationCompat.Action.Builder(R.drawable.ic_notify_tabs, getString(R.string.app_name), messagePendingIntent)
                        .build();
